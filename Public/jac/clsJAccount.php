    ...
    function checkLogin($returnURL){
        ...
        if ($this->hasValidTicket()) {
            ...
            if ($this->isSiteCookieValid()) {
                ...
                //$JAcc_redirectURL= $this->uaBaseURL . "jalogin?sid=" . $this->siteID . "&returl=" . $this->encrypt("http://127.0.0.1/dangjian/temp.php"). "&se=" .$this->encrypt();
                // echo "aaaabbbbb   ".$JAcc_redirectURL   ;
    ...
    //protected boolean hasValidTicket(HttpServletRequest request, HttpSession session)
     function hasValidTicket(){
         ...
         if ($this->userProfile == NULL) {
            ...
            // echo "@@@";
            // if ($ses=="null") echo "NULLLLLLL";
            // echo "seid=".session_id()."<br />";
            // echo "ses=".$ses."<br />";
